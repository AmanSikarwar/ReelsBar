...
- **Reel-by-reel scrolling** — trackpad and mouse-wheel input flows to the page natively (the only input Instagram's reel index follows); the feed pages under its own snap behavior. Arrow keys advance discretely.
